...
export default function ArticleCtaButton({
  ...
  const baseClassName = isIconOnly
    ? "mt-auto inline-flex items-center self-start rounded-sm bg-lime-300 p-2 text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 sm:rounded-md sm:border sm:border-zinc-200 sm:bg-white sm:p-0"
    : "mt-auto inline-flex items-center self-start rounded-md border border-zinc-200 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2";
